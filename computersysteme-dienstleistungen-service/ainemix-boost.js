...
(function(){
  'use strict';
  var CFG = {"email":"info@cds-hoffmann.de","wrongEmails":["paul@ainemix.com","vanessa@ainemix.com","noreply@ainemix.com","test@example.com"],"isRealEstate":false,"listings":[],"phone":"04103 1871662","company":"Computersysteme-Dienstleistungen-Service"};
  var doc = document;
