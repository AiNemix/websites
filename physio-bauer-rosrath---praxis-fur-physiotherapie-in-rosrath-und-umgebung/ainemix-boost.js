...
(function(){
  'use strict';
  var CFG = {"email":"info@physiobauer-roesrath.de","wrongEmails":["paul@ainemix.com","vanessa@ainemix.com","noreply@ainemix.com","test@example.com"],"isRealEstate":false,"listings":[],"phone":"02205 4858","company":"Physio Bauer Rösrath - Praxis für Physiotherapie in Rösrath und Umgebung"};
  var doc = document;
