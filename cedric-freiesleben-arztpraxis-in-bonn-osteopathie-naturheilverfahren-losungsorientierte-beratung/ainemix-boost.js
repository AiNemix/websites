...
(function(){
  'use strict';
  var CFG = {"email":"mail@praxisfreiesleben.de","wrongEmails":["paul@ainemix.com","vanessa@ainemix.com","noreply@ainemix.com","test@example.com"],"isRealEstate":false,"listings":[],"phone":"0228 2619458","company":"Cedric Freiesleben Arztpraxis in Bonn Osteopathie, Naturheilverfahren, lösungsorientierte Beratung"};
  var doc = document;
