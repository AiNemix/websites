...
(function(){
  'use strict';
  var CFG = {"email":"('orders@mywebsite-now.com')","wrongEmails":["paul@ainemix.com","vanessa@ainemix.com","noreply@ainemix.com","test@example.com"],"isRealEstate":false,"listings":[],"phone":"06821 3625749","company":"Die Auszeit Fußpflege-Kosmetik-Wellness"};
  var doc = document;
